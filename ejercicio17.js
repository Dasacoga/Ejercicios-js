let cadenas=["Juan es guapo","Adriano no es feo","Adriano deja de ser feo","Adriano deja de ser guapo","Adriano ya es guapo","No es ahora","Ahora es no","Adriano es guapo"]

let caracteristica=/^[A-C]\w+\ses\s\w+/

for (i of cadenas){
    console.log("¿La cadena "+i+" Contiene el patron ^[A-C]\w+\ses\s\w+  ?: "+caracteristica.test(i))
}
